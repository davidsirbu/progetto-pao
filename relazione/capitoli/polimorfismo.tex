...
Inoltre, è stato implementato un visitor che si occupa della modifica delle attività, togliendo questo
compito al gestore e permettendo di evitare l'uso di \texttt{dynamic\_cast} che, anche se non sostituisce
il controllo di flusso grazie alla presenza del campo univoco ID, ostacola l'estensibilità del progetto.
