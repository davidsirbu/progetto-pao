...
operazioni CRUD. Un vantaggio dell'uso di puntatori alla classe astratta \texttt{attivita} è il
rispetto del principio Open-Closed: è possibile, infatti, inserire altre classi derivate concrete
senza necessità di modificare il codice del gestore.
